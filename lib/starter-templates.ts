// Outreach templates for Blackbridge Management, voiced as Gavriel — written to
...
// {{email}}, {{phone}}. Sender identity (Gavriel / Blackbridge) is baked in.
...
export const STARTER_TEMPLATES: StarterTemplate[] = [
  // ── Warm-up / first touch ────────────────────────────────────────────────
  {
    ...
    body: "Hey {{first_name}}, it's Gavriel with Blackbridge. We help business owners get working capital fast, not a ton of paperwork. You guys looking for any funding right now?",
  },
  {
    name: "Warm-up · Casual opener",
    body: "Hey {{first_name}}, Gavriel here with Blackbridge. You currently looking for any working capital, or all good for now?",
  },
  {
    name: "Warm-up · Question hook",
    body: "Hey {{first_name}}, it's Gavriel at Blackbridge. If you could get some working capital this week without much hassle, would that help right now?",
  },
  {
    name: "Warm-up · Value (speed)",
    body: "Hey {{first_name}}, Gavriel with Blackbridge. We can usually get a decision same day and funding in a day or two. Want me to see what you'd qualify for?",
  },
  {
    name: "Warm-up · Value (flexible use)",
    body: "Hey {{first_name}}, it's Gavriel at Blackbridge. Funds can go toward payroll, inventory, equipment, whatever you need. Worth a quick look?",
  },

  // ── Re-warm / re-engage cold leads ───────────────────────────────────────
  {
    name: "Re-warm · Reconnect",
    body: "Hey {{first_name}}, it's Gavriel from Blackbridge. We talked a while back about funding. Is now a better time to take another look?",
  },
  {
    name: "Re-warm · Check-in",
    body: "Hey {{first_name}}, Gavriel from Blackbridge. Our programs have changed a lot since we last talked. Still want to explore options?",
  },
  {
    name: "Re-warm · Win-back (declined before)",
    body: "Hey {{first_name}}, it's Gavriel at Blackbridge. We added some new lenders since we last spoke, so you might qualify now even if you didn't before. Worth a quick recheck?",
  },
  {
    name: "Re-warm · Long gap",
    body: "Hey {{first_name}}, Gavriel from Blackbridge. Been a while! You still looking into funding for the business, or all set for now?",
  },
  ...
  },
  {
    ...
    body: "Hey {{first_name}}, I'll leave it here so I'm not bugging you. If funding ever comes up down the road just text me. Gavriel",
  },
  ...
  },
  {
    ...
    body: "All good, appreciate you letting me know. If anything changes down the road you've got my number. Gavriel",
  },
  {
  ...
  // ── Re-engage / renewal / referral / goodwill ────────────────────────────
  {
    ...
    body: "Hey {{first_name}}, Gavriel from Blackbridge. A lot of owners are getting set up with capital before things get busy. Want me to check what's available for you?",
  },
  {
    name: "Renewal · Existing client",
    body: "Hey {{first_name}}, it's Gavriel at Blackbridge. You've been paying down nicely, which usually means you can renew or bump up the funding. Want me to take a look?",
  },
  {
    name: "Referral · Ask",
  ...
  },
  {
    ...
    body: "Happy holidays {{first_name}}! Hope you and the team have a great one. Here whenever you need us. Gavriel",
  },
  {
